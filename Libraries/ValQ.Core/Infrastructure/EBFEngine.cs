...
using ValQ.Core.Infrastructure.Mapper;
...
{
    public class ValQEngine : IEngine
    {
        #region Utilities
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var typeFinder = new AppDomainTypeFinder();
            var startupConfigurations = typeFinder.FindClassesOfType<IValQStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IValQStartup)Activator.CreateInstance(startup))
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new ValQException("Unknown dependency");
                        return service;
                    });
            ...
            throw new ValQException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
