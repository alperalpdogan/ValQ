...
namespace ValQ.Data.Migrations
{
    ...
    [Migration("20220111173448_AddedRankHistory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ValQ.Core.Domain.Game.UserRankHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ValQ.Core.Domain.Game.UserRankHistory", b =>
                {
                    b.HasOne("ValQ.Core.Domain.Game.Rank", "NewRank")
                        .WithMany()
                        .HasForeignKey("NewRankId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ValQ.Core.Domain.Game.Rank", "OldRank")
                        .WithMany()
