...
namespace ValQ.Data.Extensions
{
    ...
    public static class DbContextExtensions
    {
        ...
        private static TEntity LoadEntityCopy<TEntity>(ValQDbContext context, TEntity entity, Func<EntityEntry<TEntity>, PropertyValues> getValuesFunction)
        ...
        /// <param name="entity">Entity</param>
        /// <returns>Copy of the passed entity</returns>
        public static TEntity LoadOriginalCopy<TEntity>(this ValQDbContext context, TEntity entity) where TEntity : BaseEntity
        {
        ...
        /// <param name="entity">Entity</param>
        /// <returns>Copy of the passed entity</returns>
        public static TEntity LoadDatabaseCopy<TEntity>(this ValQDbContext context, TEntity entity) where TEntity : BaseEntity
        {
        ...
        public static string GetTableName<TEntity>(this ValQDbContext context) where TEntity : BaseEntity
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static IEnumerable<(string Name, int? MaxLength)> GetColumnsMaxLength<TEntity>(this ValQDbContext context) where TEntity : BaseEntity
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static IEnumerable<(string Name, decimal? MaxValue)> GetDecimalColumnsMaxValue<TEntity>(this ValQDbContext context)
            where TEntity : BaseEntity
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static string DbName(this ValQDbContext context)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        /// <param name="context">Database context</param>
        /// <param name="sql">SQL script</param>
        public static void ExecuteSqlScript(this ValQDbContext context, string sql)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
        ...
        public static void ExecuteSqlScriptFromFile(this ValQDbContext context, string filePath)
        {
            if (context == null)
                throw new ArgumentNullException(nameof(context));
